package mod.sol.celestialbodies.sedna.world.gen;
...
public class ChunkProviderSedna extends ChunkProviderSolNoise {
    public ChunkProviderSedna(World world, long seed) { super(world, seed); }
    @Override protected float getNoiseScale() { return 0.25F; }
    ...
    @Override protected IBlockState getFillBlock(int x, int y, int z, Biome b) { return SolBlocks.SEDNA_SUB_SURFACE_ROCK.getDefaultState(); }
    @Override protected IBlockState getLowerBlock() { return SolBlocks.SEDNA_ROCK.getDefaultState(); }
    @Override protected MapGenBaseMeta createCaveGenerator() { return new MapGenCavesSedna(); }
