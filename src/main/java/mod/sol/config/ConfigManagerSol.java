...
public class ConfigManagerSol {
    ...
    public static void init(File file) {
        ...
        dimensionidKuiperBelt = config.getInt("Dimension ID for Kuiper Belt", categoryDimensionids, -(Reference.MOD_ID.hashCode() + 1000), -999999999, 999999999, "None");
        dimensionidSedna = config.getInt("Dimension ID for Sedna", categoryDimensionids, -(Reference.MOD_ID.hashCode() + 1100), -999999999, 999999999, "None");
