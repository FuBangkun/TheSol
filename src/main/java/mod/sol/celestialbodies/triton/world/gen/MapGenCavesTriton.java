package mod.sol.celestialbodies.triton.world.gen;
...
public class MapGenCavesTriton extends MapGenBaseMeta {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++) {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D) {
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
                                            ...
                                            if (state.getBlock() == SolBlocks.TRITON_SOFT_ROCK || state.getBlock() == SolBlocks.TRITON_TURF || state.getBlock() == SolBlocks.TRITON_SURFACE_ROCK || state.getBlock() == SolBlocks.TRITON_ROCK || state.getBlock() == SolBlocks.TRITON_DIRT) {
