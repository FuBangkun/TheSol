...
public class ItemTier7Rocket extends Item implements IHoldableItem, ISortableItem, IHasModel {
    public ItemTier7Rocket(String assetName) {
        super();
        this.setMaxDamage(0);
    ...
    public static boolean placeRocketOnPad(ItemStack stack, World worldIn, TileEntity tile, float centerX, float centerY, float centerZ) {
        ...
        EntityTier7Rocket rocket = new EntityTier7Rocket(worldIn, centerX, centerY, centerZ, EnumRocketType.values()[stack.getItemDamage()]);
    ...
    public String getTranslationKey(ItemStack par1ItemStack) {
        return super.getTranslationKey(par1ItemStack) + ".t7Rocket";
    }
