...
public class MapGenCavesSedna extends MapGenBaseMeta {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++) {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D) {
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
                                            ...
                                            if (state.getBlock() == SolBlocks.SEDNA_SURFACE_ROCK || state.getBlock() == SolBlocks.SEDNA_TURF || state.getBlock() == SolBlocks.SEDNA_SUB_SURFACE_ROCK || state.getBlock() == SolBlocks.SEDNA_ROCK) {
