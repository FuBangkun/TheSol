...
public class ChunkProviderMercury extends ChunkProviderBase {
    public static final IBlockState BLOCK_TOP = SolBlocks.MERCURY_TURF.getDefaultState();
    public static final IBlockState BLOCK_FILL = SolBlocks.MERCURY_DIRT.getDefaultState();
    public static final IBlockState BLOCK_LOWER = SolBlocks.MERCURY_ROCK.getDefaultState();
    ...
    public ChunkProviderMercury(World par1World, long par2, boolean par4) {
        ...
        this.noiseGen1 = new Gradient(this.rand.nextLong(), 16, 0.15F);
        this.noiseGen2 = new Gradient(this.rand.nextLong(), 16, 0.15F);
        this.noiseGen3 = new Gradient(this.rand.nextLong(), 8, 0.15F);
        this.noiseGen4 = new Gradient(this.rand.nextLong(), 8, 0.15F);
    }

    public void setBlocksInChunk(int chunkX, int chunkZ, ChunkPrimer primer) {
        this.noiseGen1.setFrequency(0.025F);
        this.noiseGen2.setFrequency(0.030F);
        this.noiseGen3.setFrequency(0.005F);
        this.noiseGen4.setFrequency(0.015F);
    ...
    public Chunk generateChunk(int x, int z) {
        ...
        this.dungeonGeneratorMercury.generate(this.world, x, z, chunkprimer);
    ...
    public void populate(int x, int z) {
        ...
        this.dungeonGeneratorMercury.generateStructure(this.world, this.rand, new ChunkPos(x, z));
    ...
    public void recreateStructures(Chunk chunk, int x, int z) {
        ...
        this.dungeonGeneratorMercury.generate(this.world, x, z, null);
    }
}
