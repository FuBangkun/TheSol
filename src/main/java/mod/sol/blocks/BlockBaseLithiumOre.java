...
public class BlockBaseLithiumOre extends Block implements IHasModel {
    public BlockBaseLithiumOre(String name, Material material, String toolClass, int harvestLevel, CreativeTabs tab) {
        super(material);
