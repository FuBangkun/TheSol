...
public class RoomTreasureMercury extends RoomTreasure {
    public static ResourceLocation MERCURYCHEST = new ResourceLocation(Reference.MOD_ID, "dungeon_tier_4");
    // public static ResourceLocation MERCURYCHEST = new ResourceLocation("galacticraftcore", "dungeon_tier_3");
    public static final ResourceLocation TABLE_TIER_4_DUNGEON = LootTableList.register(MERCURYCHEST);
