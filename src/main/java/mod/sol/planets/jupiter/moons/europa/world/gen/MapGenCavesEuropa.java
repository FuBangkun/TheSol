...
public class MapGenCavesEuropa extends MapGenBaseMeta {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++) {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D) {
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
                                            ...
                                            if (state.getBlock() == SolBlocks.EUROPA_ROCK || state.getBlock() == SolBlocks.EUROPA_SUB_SURFACE_ROCK || state.getBlock() == SolBlocks.EUROPA_SURFACE_ROCK || state.getBlock() == Blocks.PACKED_ICE || state.getBlock() == Blocks.SNOW_LAYER || state.getBlock() == Blocks.WATER) {
                                                if (localY <= 78) {
