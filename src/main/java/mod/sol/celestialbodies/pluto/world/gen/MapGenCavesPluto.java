...
public class MapGenCavesPluto extends MapGenBaseMeta {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++) {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D) {
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
                                            ...
                                            if (state.getBlock() == SolBlocks.PLUTO_SURFACE_ROCK || state.getBlock() == SolBlocks.PLUTO_SUB_SURFACE_ROCK || state.getBlock() == SolBlocks.PLUTO_ROCK || state.getBlock() == Blocks.SNOW || state.getBlock() == Blocks.SNOW_LAYER) {
