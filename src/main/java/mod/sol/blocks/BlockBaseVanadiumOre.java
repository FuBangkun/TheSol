...
public class BlockBaseVanadiumOre extends Block implements IHasModel {
    public BlockBaseVanadiumOre(String name, Material material, String toolClass, int harvestLevel, CreativeTabs tab) {
        super(material);
