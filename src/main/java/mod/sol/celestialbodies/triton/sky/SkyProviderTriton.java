package mod.sol.celestialbodies.triton.sky;
...
public class SkyProviderTriton extends IRenderHandler {
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        var12 = 2.5F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderTriton.sunTexture);
