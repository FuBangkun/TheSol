...
public class Tier6RocketRecipeCategory implements IRecipeCategory {
    private static final ResourceLocation rocketGuiTexture = new ResourceLocation(Reference.MOD_ID, "textures/gui/schematic_rocket_t6_jei.png");
    ...
    public String getUid() {
        return SolJeiManager.ROCKET_T6_ID;
    }
