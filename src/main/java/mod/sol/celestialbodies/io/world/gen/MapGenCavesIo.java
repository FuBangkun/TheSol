package mod.sol.celestialbodies.io.world.gen;
...
public class MapGenCavesIo extends MapGenBaseMeta {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++) {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D) {
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
                                            ...
                                            if (state.getBlock() == SolBlocks.IO_ASH_BLOCK || state.getBlock() == SolBlocks.IO_ROCK || state.getBlock() == SolBlocks.IO_SUB_SURFACE_ROCK || state.getBlock() == SolBlocks.IO_SULFUR_BLOCK || state.getBlock() == SolBlocks.IO_SURFACE_ROCK) {
