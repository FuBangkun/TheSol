...
public class TileEntityTreasureTier6ChestRenderer extends TileEntitySpecialRenderer<TileEntityTreasureChestTier6> {
    ...
    @Override
    public void render(TileEntityTreasureChestTier6 chest, double x, double y, double z, float par7, int par8, float alpha) {
        int var9;
        ...
        this.bindTexture(TileEntityTreasureTier6ChestRenderer.treasureChestTexture);
