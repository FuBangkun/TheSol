...
public class EntitySaturnBossStray extends EntityBossBase implements IEntityBreathable, IRangedAttackMob, IIgnoreShift {
    ...
    public EntitySaturnBossStray(World par1World) {
        super(par1World);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(800.0F * ConfigManagerCore.dungeonBossHealthMod);
...
//    }
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float f) {
        ...
        if (rand.nextBoolean())
            arrow.addEffect(new PotionEffect(MobEffects.SLOWNESS, 800, 1));
        else
            arrow.addEffect(new PotionEffect(MobEffects.SLOWNESS, 50, 255));
    ...
    @Override
    public void dropKey() {
        this.entityDropItem(new ItemStack(SolItems.KEY_TIER_6), 0.5F);
    }
