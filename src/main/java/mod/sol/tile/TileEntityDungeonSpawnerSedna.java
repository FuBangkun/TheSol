...
public class TileEntityDungeonSpawnerSedna extends TileEntityDungeonSpawner<EntityBossMagmaCube> {
    public TileEntityDungeonSpawnerSedna() {
        super(EntityBossMagmaCube.class);
    }
