...
public class Tier7RocketRecipeCategory implements IRecipeCategory {
    private static final ResourceLocation rocketGuiTexture = new ResourceLocation(Reference.MOD_ID, "textures/gui/schematic_rocket_t7_jei.png");
    ...
    public String getUid() {
        return SolJeiManager.ROCKET_T7_ID;
    }
