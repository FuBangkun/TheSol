...
public class TeleportTypeUniversal implements ITeleportType {
    @Override
    ...
    public void onSpaceDimensionChanged(World newWorld, EntityPlayerMP player, boolean ridingAutoRocket) {
        ...
        if (!ridingAutoRocket && !ConfigManagerCore.disableLander && stats.getTeleportCooldown() <= 0) {
            ...
            if (!newWorld.isRemote) {
                ...
                TheSol.LOGGER.debug("Entering lander at : {},{} lander spawn at: {},{}", player.posX, player.posZ, lander.posX, lander.posZ);
            }
