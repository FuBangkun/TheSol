package mod.sol.planets.saturn.moons.titan.world.gen;
...
public class MapGenCavesTitan extends MapGenBaseMeta {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++) {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D) {
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
                                            ...
                                            if (state.getBlock() == SolBlocks.TITAN_ROCK || state.getBlock() == SolBlocks.TITAN_SUB_SURFACE_ROCK || state.getBlock() == SolBlocks.TITAN_SURFACE_ROCK) {
                                                if (localY <= 62) {
