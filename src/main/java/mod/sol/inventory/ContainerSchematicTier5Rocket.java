...
public class ContainerSchematicTier5Rocket extends Container {
    ...
    public ContainerSchematicTier5Rocket(InventoryPlayer par1InventoryPlayer, BlockPos pos) {
        ...
        // input rocket
        this.addSlotToContainer(new SlotSchematicTier5Rocket(this.craftMatrix, 22, 145, -15 + change + change, pos, par1InventoryPlayer.player));
    ...
    public void onCraftMatrixChanged(IInventory par1IInventory) {
        this.craftResult.setInventorySlotContents(0, RecipeUtilSol.findMatchingSpaceshipT5Recipe(this.craftMatrix));
    }
