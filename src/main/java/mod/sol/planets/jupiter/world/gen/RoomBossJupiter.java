...
public class RoomBossJupiter extends RoomBoss {
    ...
    public boolean addComponentParts(World worldIn, Random random, StructureBoundingBox chunkBox) {
        ...
        if (chunkBox.isVecInside(blockpos)) {
            worldIn.setBlockState(blockpos, SolBlocks.BOSS_SPAWNER_JUPITER.getDefaultState(), 2);
            ...
            if (spawner != null) {
                spawner.setRoom(new Vector3(this.boundingBox.minX + 1, this.boundingBox.minY + 1, this.boundingBox.minZ + 1), new Vector3(this.sizeX - 1, this.sizeY + 3, this.sizeZ - 1));
            }
        }
