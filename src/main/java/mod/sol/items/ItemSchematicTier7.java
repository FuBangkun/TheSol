...
public class ItemSchematicTier7 extends ItemSchematic implements ISchematicItem, ISortableItem, IHasModel {
    private static int indexOffset = 0;

    public ItemSchematicTier7(String name) {
        super("schematic");
    ...
    public static void registerSchematicItems() {
        indexOffset = SchematicRegistry.registerSchematicItem(new ItemStack(SolItems.SCHEMATIC_T7, 1, 0));
    }
    ...
    public static void registerTextures() {
        SchematicRegistry.registerTexture(new ResourceLocation(Reference.MOD_ID, "textures/items/schematic_rocket_t7.png"));
    }
