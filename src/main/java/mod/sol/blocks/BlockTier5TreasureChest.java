...
public class BlockTier5TreasureChest extends BlockTier1TreasureChest implements IHasModel {

    public BlockTier5TreasureChest(String name) {
        super(name);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileEntityTreasureChestTier5();
    }
