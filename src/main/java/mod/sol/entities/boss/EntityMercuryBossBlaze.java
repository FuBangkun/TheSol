...
public class EntityMercuryBossBlaze extends EntityBossBase implements IEntityBreathable {
    ...
    public EntityMercuryBossBlaze(World worldIn) {
        super(worldIn);
        this.setSize(3F, 7.0F);
    ...
    protected void initEntityAI() {
        this.tasks.addTask(4, new EntityMercuryBossBlaze.AIFireballAttack(this));
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(400.0F * ConfigManagerCore.dungeonBossHealthMod);
    }
    ...
    static class AIFireballAttack extends EntityAIBase {
        private final EntityMercuryBossBlaze blaze;
        private int attackStep;
        private int attackTime;

        public AIFireballAttack(EntityMercuryBossBlaze blazeIn) {
            this.blaze = blazeIn;
            this.setMutexBits(6);
        }
