package mod.sol.celestialbodies.mercury.world.gen;
...
public class MapGenCavesMercury extends MapGenBaseMeta {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++) {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D) {
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
                                            ...
                                            if (state.getBlock() == SolBlocks.MERCURY_TURF || state.getBlock() == SolBlocks.MERCURY_DIRT || state.getBlock() == SolBlocks.MERCURY_ROCK) {
