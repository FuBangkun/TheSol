...
import mod.sol.celestialbodies.europa.SkyProviderEuropa;
import mod.sol.celestialbodies.io.WorldProviderIo;
import mod.sol.celestialbodies.io.SkyProviderIo;
import mod.sol.celestialbodies.mercury.WorldProviderMercury;
import mod.sol.celestialbodies.mercury.SkyProviderMercury;
import mod.sol.celestialbodies.triton.WorldProviderTriton;
import mod.sol.celestialbodies.triton.SkyProviderTriton;
import mod.sol.celestialbodies.pluto.WorldProviderPluto;
import mod.sol.celestialbodies.pluto.SkyProviderPluto;
import mod.sol.celestialbodies.mimas.WorldProviderMimas;
import mod.sol.celestialbodies.mimas.SkyProviderMimas;
import mod.sol.celestialbodies.titan.WorldProviderTitan;
import mod.sol.celestialbodies.titan.SkyProviderTitan;
import mod.sol.celestialbodies.sedna.WorldProviderSedna;
import mod.sol.celestialbodies.sedna.SkyProviderSedna;
import mod.sol.celestialbodies.ariel.WorldProviderAriel;
import mod.sol.celestialbodies.ariel.SkyProviderAriel;
    ...
    public static class TickHandlerClient {
        ...
        public void onRingRender(CelestialBodyRenderEvent.CelestialRingRenderEvent.Pre renderEvent) {
            ...
            if (body.equals(SolPlanets.planetCeres) || body.equals(SolPlanets.planetPluto) || body.equals(SolPlanets.planetSedna) || body.equals(SolPlanets.planetHaumea) || body.equals(SolPlanets.planetMakemake) || body.equals(SolPlanets.planetEris)) {
                ...
                GL11.glEnd();
            } else if (body.equals(SolPlanets.planetKuiperBelt)) {
                float alpha = 1.0F;
                GuiScreen screen = FMLClientHandler.instance().getClient().currentScreen;
                if (screen instanceof GuiCelestialSelection) {
                    alpha = ((GuiCelestialSelection) screen).getAlpha(body);
        ...
        public void onBodyRender(CelestialBodyRenderEvent.Pre renderEvent) {
            CelestialBody body = renderEvent.celestialBody;
            if (body.equals(SolPlanets.planetKuiperBelt)) {
