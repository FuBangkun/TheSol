...
public class BiomeGenValleyEuropa extends BiomeEuropa {
    public BiomeGenValleyEuropa(BiomeProperties properties) {
        super(properties);
    }
    ...
    @Override
    public void genTerrainBlocks(World worldIn, Random rand, @Nonnull ChunkPrimer chunkPrimerIn, int p_180622_4_, int p_180622_5_, double p_180622_6_) {
        ...
        IBlockState gravelBlock = SolBlocks.EUROPA_SUB_SURFACE_ROCK.getDefaultState();
