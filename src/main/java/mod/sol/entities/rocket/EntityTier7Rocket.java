package mod.sol.entities.rocket;
...
public class EntityTier7Rocket extends EntityTieredRocket {
    ...
    public EntityTier7Rocket(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, NonNullList<ItemStack> inv) {
    ...
    public ItemStack getPickedResult(RayTraceResult target) {
        return new ItemStack(SolItems.ROCKET_T7, 1, this.rocketType.getIndex());
    }
    ...
    public void onTeleport(EntityPlayerMP player) {
        ...
        if (playerBase != null) {
            ...
            stats.setRocketItem(SolItems.ROCKET_T7);
    ...
    public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems) {
        ...
        ItemStack rocket = new ItemStack(SolItems.ROCKET_T7, 1, this.rocketType.getIndex());
