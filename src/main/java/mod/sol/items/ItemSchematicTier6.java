...
public class ItemSchematicTier6 extends ItemSchematic implements ISchematicItem, ISortableItem, IHasModel {
    private static int indexOffset = 0;

    public ItemSchematicTier6(String name) {
        super("schematic");
    ...
    public static void registerSchematicItems() {
        indexOffset = SchematicRegistry.registerSchematicItem(new ItemStack(SolItems.SCHEMATIC_T6, 1, 0));
    }
    ...
    public static void registerTextures() {
        SchematicRegistry.registerTexture(new ResourceLocation(Reference.MOD_ID, "textures/items/schematic_rocket_t6.png"));
    }
