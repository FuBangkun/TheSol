...
public class ModelSaturnBossStray extends ModelBase {
    ...
    public ModelSaturnBossStray() {
        ...
        this.setRotation(this.upperHead, 0.122173F, 0F);
        ...
        this.setRotation(this.pelvis, 0F, 0F);
        ...
        this.setRotation(this.sternum, 0F, 0F);
        ...
        this.rightLeg.mirror = true;
        this.setRotation(this.rightLeg, 0F, 0F);
        ...
        this.setRotation(this.rightArm, 0F, 0F);
        ...
        this.setRotation(this.spine, 0F, 0F);
        ...
        this.setRotation(this.leftArm, 0F, 0F);
        ...
        this.setRotation(this.leftLeg, 0F, 0F);
        ...
        this.setRotation(this.leftFrontBotRib, 0F, -halfPI);
        ...
        this.setRotation(this.leftFrontTopRib, 0F, -halfPI);
        ...
        this.setRotation(this.leftFront2ndRib, 0F, -halfPI);
        ...
        this.setRotation(this.leftFront3rdRib, 0F, -halfPI);
        ...
        this.setRotation(this.leftSideBotRib, 0F, 0F);
        ...
        this.setRotation(this.leftSide3rdRib, 0F, 0F);
        ...
        this.setRotation(this.leftSide2ndRib, 0F, 0F);
        ...
        this.setRotation(this.leftSideTopRib, 0F, 0F);
        ...
        this.setRotation(this.rightSideTopRib, 0F, 0F);
        ...
        this.setRotation(this.rightSide2ndRib, 0F, 0F);
        ...
        this.setRotation(this.rightSide3rdRib, 0F, 0F);
        ...
        this.setRotation(this.rightSideBotRib, 0F, 0F);
        ...
        this.setRotation(this.rightFrontBotRib, 0F, halfPI);
        ...
        this.setRotation(this.rightFront3rdRib, 0F, halfPI);
        ...
        this.setRotation(this.rightFront2ndRib, 0F, halfPI);
        ...
        this.setRotation(this.rightFrontTopRib, 0F, halfPI);
        ...
        this.setRotation(this.leftBackTopRib, 0F, -halfPI);
        ...
        this.setRotation(this.leftBack2ndRib, 0F, -halfPI);
        ...
        this.setRotation(this.leftBack3rdRib, 0F, -halfPI);
        ...
        this.setRotation(this.leftBackBotRib, 0F, -halfPI);
        ...
        this.setRotation(this.rightBackBotRib, 0F, halfPI);
        ...
        this.setRotation(this.rightBack3rdRib, 0F, halfPI);
        ...
        this.setRotation(this.rightBack2ndRib, 0F, halfPI);
        ...
        this.setRotation(this.rightBackTopRib, 0F, halfPI);
    }
    ...
    @Override
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, @Nonnull Entity e) {
