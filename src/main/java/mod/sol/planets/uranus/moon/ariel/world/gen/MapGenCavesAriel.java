...
public class MapGenCavesAriel extends MapGenBaseMeta {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++) {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D) {
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
                                            ...
                                            if (state.getBlock() == SolBlocks.ARIEL_TURF || state.getBlock() == SolBlocks.ARIEL_DIRT || state.getBlock() == SolBlocks.ARIEL_ROCK) {
