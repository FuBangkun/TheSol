...
import mod.sol.entities.rocket.EntityTier8Rocket;
...
public class ItemTier8Rocket extends Item implements IHoldableItem, ISortableItem, IHasModel {
    public ItemTier8Rocket(String assetName) {
        super();
        this.setMaxDamage(0);
    ...
    public static boolean placeRocketOnPad(ItemStack stack, World worldIn, TileEntity tile, float centerX, float centerY, float centerZ) {
        ...
        EntityTier8Rocket rocket = new EntityTier8Rocket(worldIn, centerX, centerY, centerZ, EnumRocketType.values()[stack.getItemDamage()]);
    ...
    public String getTranslationKey(ItemStack par1ItemStack) {
        return super.getTranslationKey(par1ItemStack) + ".t8Rocket";
    }
