...
public class SolItems {
    ...
    public static final Item SCHEMATIC_T4 = new ItemSchematicTier("schematic_rocket_t4", 4);
    ...
    public static final Item SCHEMATIC_T5 = new ItemSchematicTier("schematic_rocket_t5", 5);
    ...
    public static final Item SCHEMATIC_T6 = new ItemSchematicTier("schematic_rocket_t6", 6);
    ...
    public static final Item SCHEMATIC_T7 = new ItemSchematicTier("schematic_rocket_t7", 7);
    ...
    public static final Item SCHEMATIC_T8 = new ItemSchematicTier("schematic_rocket_t8", 8);
    ...
    public static final Item SCHEMATIC_T9 = new ItemSchematicTier("schematic_rocket_t9", 9);
    ...
    public static final Item SCHEMATIC_T10 = new ItemSchematicTier("schematic_rocket_t10", 10);
    // battery
