package mod.sol.planets.saturn.moons.mimas.sky;
...
public class SkyProviderMimas extends IRenderHandler {
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        WorldProviderIo gcProvider = null;

        if (world.provider instanceof WorldProviderIo) {
            gcProvider = (WorldProviderIo) world.provider;
        }
        ...
        var12 = 6.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderMimas.sunTexture);
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderMimas.overworldTexture);
