...
public class GuiSchematicTier5Rocket extends GuiPositionedContainer implements ISchematicResultPage {
    private static final ResourceLocation schematicTexture = new ResourceLocation(Reference.MOD_ID, "textures/gui/schematic_rocket_t5.png");
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRenderer.drawString(SolItems.ROCKET_T5.getItemStackDisplayName(new ItemStack(SolItems.ROCKET_T5, 1, 0)), 7, -20 + 27, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        this.mc.renderEngine.bindTexture(GuiSchematicTier5Rocket.schematicTexture);
