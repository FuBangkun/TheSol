...
import mod.sol.celestialbodies.GenLayerUniversal;
...
public class BiomeProviderIo extends BiomeProvider {
    ...
    public BiomeProviderIo(long seed, WorldType type) {
        this();
        GenLayer[] genLayers = GenLayerUniversal.createWorld(seed, SolPlanets.moonIo.biomesToGenerate.toArray(new Biome[0]));
