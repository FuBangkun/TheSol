...
public class ChunkProviderIo extends ChunkProviderBase {
    public static final IBlockState BLOCK_TOP = SolBlocks.IO_SULFUR_BLOCK.getDefaultState();
    public static final IBlockState BLOCK_FILL = SolBlocks.IO_SUB_SURFACE_ROCK.getDefaultState();
    public static final IBlockState BLOCK_LOWER = SolBlocks.IO_ROCK.getDefaultState();
    ...
    public ChunkProviderIo(World par1World, long par2, boolean par4) {
        ...
        this.noiseGen1 = new Gradient(this.rand.nextLong(), 4, 0.125F);
        this.noiseGen2 = new Gradient(this.rand.nextLong(), 4, 0.125F);
        this.noiseGen3 = new Gradient(this.rand.nextLong(), 1, 0.125F);
        this.noiseGen4 = new Gradient(this.rand.nextLong(), 1, 0.125F);
    }

    public void setBlocksInChunk(int chunkX, int chunkZ, ChunkPrimer primer) {
        this.noiseGen1.setFrequency(0.03F);
        this.noiseGen2.setFrequency(0.025F);
        this.noiseGen3.setFrequency(0.02F);
        this.noiseGen4.setFrequency(0.03F);
