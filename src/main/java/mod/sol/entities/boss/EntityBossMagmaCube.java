...
public class EntityBossMagmaCube extends EntityBossBase implements IMob, IEntityBreathable {
    ...
    public EntityBossMagmaCube(World worldIn) {
        super(worldIn);
        this.setSize(5, 5);
        this.moveHelper = new EntityBossMagmaCube.SlimeMoveHelper(this);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(5, new EntityBossMagmaCube.AISlimeHop(this));
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(12.0D * difficulty);
    }
    ...
    @Override
    public void dropKey() {
        this.entityDropItem(new ItemStack(SolItems.KEY_TIER_10), 0.5F);
    }
