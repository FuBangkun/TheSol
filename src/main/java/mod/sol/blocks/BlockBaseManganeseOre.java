...
public class BlockBaseManganeseOre extends Block implements IHasModel {
    public BlockBaseManganeseOre(String name, Material material, String toolClass, int harvestLevel, CreativeTabs tab) {
        super(material);
