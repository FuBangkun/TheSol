...
public class ChunkProviderPluto extends ChunkProviderBase {
    public static final IBlockState BLOCK_TOP = SolBlocks.PLUTO_SURFACE_ROCK.getDefaultState();
    public static final IBlockState BLOCK_FILL = SolBlocks.PLUTO_SUB_SURFACE_ROCK.getDefaultState();
    public static final IBlockState BLOCK_LOWER = SolBlocks.PLUTO_ROCK.getDefaultState();
    ...
    public ChunkProviderPluto(World par1World, long par2, boolean par4) {
        ...
        this.noiseGen1 = new Gradient(this.rand.nextLong(), 4, 0.5F);
        this.noiseGen2 = new Gradient(this.rand.nextLong(), 4, 0.5F);
        this.noiseGen3 = new Gradient(this.rand.nextLong(), 1, 0.5F);
