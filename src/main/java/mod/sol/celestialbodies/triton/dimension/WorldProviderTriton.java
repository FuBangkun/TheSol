package mod.sol.celestialbodies.triton.dimension;
...
import mod.sol.celestialbodies.triton.world.gen.ChunkProviderTriton;
...
public class WorldProviderTriton extends WorldProviderSpace implements IGalacticraftWorldProvider, ISolarLevel {
    ...
    public List<Block> getSurfaceBlocks() {
        ...
        list.add(SolBlocks.TRITON_TURF);
        return list;
    }
}
