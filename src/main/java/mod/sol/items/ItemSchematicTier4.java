...
public class ItemSchematicTier4 extends ItemSchematic implements ISchematicItem, ISortableItem, IHasModel {
    private static int indexOffset = 0;

    public ItemSchematicTier4(String name) {
        super("schematic");
    ...
    public static void registerSchematicItems() {
        indexOffset = SchematicRegistry.registerSchematicItem(new ItemStack(SolItems.SCHEMATIC_T4, 1, 0));
    }
    ...
    public static void registerTextures() {
        SchematicRegistry.registerTexture(new ResourceLocation(Reference.MOD_ID, "textures/items/schematic_rocket_t4.png"));
    }
