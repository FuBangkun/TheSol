...
public class EntityTier4Rocket extends EntityTieredRocket {
    ...
    public ItemStack getPickedResult(RayTraceResult target) {
        return new ItemStack(SolItems.ROCKET_T4, 1, this.rocketType.getIndex());
    }
    ...
    public void onTeleport(EntityPlayerMP player) {
        ...
        if (playerBase != null) {
            ...
            stats.setRocketItem(SolItems.ROCKET_T4);
    ...
    public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems) {
        ...
        ItemStack rocket = new ItemStack(SolItems.ROCKET_T4, 1, this.rocketType.getIndex());
