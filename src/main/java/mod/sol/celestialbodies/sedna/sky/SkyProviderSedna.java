package mod.sol.celestialbodies.sedna.sky;
...
public class SkyProviderSedna extends IRenderHandler {
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        var12 = 1.5F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderSedna.sunTexture);
