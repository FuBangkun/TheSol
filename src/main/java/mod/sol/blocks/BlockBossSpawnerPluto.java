...
import mod.sol.tile.TileEntityDungeonSpawnerPluto;
...
public class BlockBossSpawnerPluto extends BlockBossSpawner implements IHasModel {
    public BlockBossSpawnerPluto(String assetName) {
        super(assetName);
