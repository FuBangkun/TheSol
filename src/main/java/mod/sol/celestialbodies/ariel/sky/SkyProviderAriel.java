package mod.sol.celestialbodies.ariel.sky;
...
public class SkyProviderAriel extends IRenderHandler {
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        var12 = 3.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderAriel.sunTexture);
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderAriel.overworldTexture);
