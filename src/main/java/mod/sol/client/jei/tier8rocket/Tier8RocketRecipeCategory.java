...
public class Tier8RocketRecipeCategory implements IRecipeCategory {
    private static final ResourceLocation rocketGuiTexture = new ResourceLocation(Reference.MOD_ID, "textures/gui/schematic_rocket_t8_jei.png");
    ...
    public String getUid() {
        return SolJeiManager.ROCKET_T8_ID;
    }
