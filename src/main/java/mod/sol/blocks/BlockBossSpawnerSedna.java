...
public class BlockBossSpawnerSedna extends BlockBossSpawner implements IHasModel {
    public BlockBossSpawnerSedna(String assetName) {
        super(assetName);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileEntityDungeonSpawnerSedna();
    }
