...
public class ItemSchematicTier9 extends ItemSchematic implements ISchematicItem, ISortableItem, IHasModel {
    private static int indexOffset = 0;

    public ItemSchematicTier9(String name) {
        super("schematic");
    ...
    public static void registerTextures() {
        SchematicRegistry.registerTexture(new ResourceLocation(Reference.MOD_ID, "textures/items/schematic_rocket_t9.png"));
    }
