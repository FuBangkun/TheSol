...
public class BlockBaseOsmiumOre extends Block implements IHasModel {
    public BlockBaseOsmiumOre(String name, Material material, String toolClass, int harvestLevel, CreativeTabs tab) {
        super(material);
